...
- **Rarity:** uncommon  |  **Category:** force  |  **Type:** Snare  |  **Alignment:** Fear
...
- Consensus: Needs everyone to agree before it can work.
- Discipline Tax: Punishes the trader who followed the rules.
- Speed: Reclaims the level before the analysis is published.
...
> The Bear Trap punishes the correct interpretation of a false event. The level breaks, the analysis is sound, the exit is disciplined, and the price returns by morning. It exists because liquidity sits where consensus is tidiest.
