# 069 - The Support Line
*Held, Until It Didn't*

- **Rarity:** common  |  **Category:** force  |  **Type:** Threshold  |  **Alignment:** Faith
...
- Consensus: Real only while enough people agree it is.
- Magnetism: Draws orders toward a number for no physical reason.
- Fatigue: Each successful test makes the next one weaker.
...
> A support line is a rumour that enough people believe to make temporarily true. It works because it is watched, and it fails because it is crowded. Once broken, the same price becomes a ceiling, and the same crowd defends the other side.
