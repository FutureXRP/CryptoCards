# 080 - The Nonce
*Used Once, Then Never*

- **Rarity:** common  |  **Category:** relic  |  **Type:** Cipher  |  **Alignment:** Neutral
...
- Counting: Security from a number that only goes up.
- Ordering: Transactions execute in sequence or not at all.
- Disposability: Trillions are tried and thrown away every second.
...
> The nonce is the least glamorous number in this world and one of the load-bearing ones. It makes replay impossible and ordering absolute, using nothing but counting. In mining it is the lottery ticket, discarded by the trillion until one wins.
