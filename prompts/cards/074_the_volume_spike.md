# 074 - The Volume Spike
*Something Just Happened*

- **Rarity:** common  |  **Category:** force  |  **Type:** Omen  |  **Alignment:** Chaos
...
- Evidence: Proof that something real occurred.
- Silence: Reports magnitude without reporting cause.
- Precedence: Arrives before the announcement it reflects.
...
> Volume is the only honest signal on the chart, because it cannot be drawn afterward. A spike means something happened, and says nothing about what. By the time the reason is published, the participants who knew have already finished.
