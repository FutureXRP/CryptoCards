...
- **Rarity:** common  |  **Category:** force  |  **Type:** Rite  |  **Alignment:** Neutral
...
- Humility: Admits the plan was the problem.
- Flatness: No position is also a position.
- Rules: Returns with something written down.
...
> Every survivor here has reset at least once, usually after being certain they would not need to. The account goes to zero or to cash, and the lessons are the only inventory carried forward. The second attempt is quieter and works better.
