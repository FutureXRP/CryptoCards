...
- **Rarity:** common  |  **Category:** force  |  **Type:** Miasma  |  **Alignment:** Fear
...
- Velocity: Outruns every correction ever issued.
- Deniability: Only asked a question, technically.
- Weaponised: Cheap to produce and costly to answer.
...
> Doubt is cheap to manufacture and expensive to disprove, which makes it an excellent weapon and an occasional public service. The same rumour that destroys an honest project also warns about a dishonest one. Nobody can tell which is which until afterward.
