# 037 - The Sniper
*First Block, First Blood*

- **Rarity:** uncommon  |  **Category:** archetype  |  **Type:** Hunter  |  **Alignment:** Greed
...
- Latency: Wins by milliseconds against thousands of identical scripts.
- Preparation: Everything is signed before anything is announced.
- Indifference: Neither believes nor disbelieves the project.
...
> The Sniper competes in a race measured in blocks and decided by preparation. Research happens afterward, if at all, because by then the position is already closed. Half the launches taken this way are frauds, and the maths still works.
