# 098 - The Accumulation
*Boring on Purpose*

- **Rarity:** common  |  **Category:** force  |  **Type:** Season  |  **Alignment:** Neutral
...
- Boredom: Nothing happens, deliberately, for a long time.
- Discretion: Bought without announcement or applause.
- Duration: Measured in quarters rather than sessions.
...
> Accumulation is the least photogenic phase and the only profitable one to be early in. Nothing happens for months, which is the mechanism rather than a failure of it. Everything the next cycle celebrates was purchased here, quietly, by people who were bored.
