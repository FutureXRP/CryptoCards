# STATUS.md — Crypto Lore Series, Genesis Series 2026

Live progress tracker. Regenerate after every session; the manifest is the
...
| 050 | The Halving | legendary | force | art_approved |
| 051 | The Genesis Block | legendary | relic | art_approved |
...
| 056 | The Crypto Winter | legendary | force | art_approved |
...
| 081 | The Bitcoin | legendary | token | art_approved |
| 082 | The Ethereum | legendary | token | art_approved |
...
2. Epic block next: 005, 007, 008, 018, 022*, 026, 27*, 29, 31*, 32* need
   content or art prompts (* = lore_complete already).
3. Art generation for Mythic/Legendary cards once the owner approves the
   written content in this file's lore fields.
